     ...
     <div class="modal-dialog modal-dialog-scrollable modal-lg ">
       <div class="modal-content">
         <div class="modal-header alert bg0">
          <h4 class="modal-title text-white"> <strong>Nuevo Compra</strong> </h4>
  ...
  <div class="container-fluid">
	<div class="row">
	             ...
	             <div class="form-group col-md-6">                          
                    <label for="inputText" class="col-sm-3 col-form-label"><strong>Proveedores</strong></label>
                    <div class="input-group">
                     
                      <select class="form-control select2" placeholder="Cédula" id="cedula">
                        <option value="0" selected disabled>Proveedores</option>
                        <?php if(isset($mostrarC)){
                          foreach($mostrarC as $data){
                            ?> 
                            <option value="<?php echo $data->codigoproveedores;?>" class="opcion"><?php echo $data->nombre;?> <?php echo $data->codigoproveedores;?></option>
                            <?php
                          }
                        }else{"";}?>
                      </select> 
...
<!--FIN MODAL ELIMINAR-->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title"><strong id="compraNombre"></strong></h3>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
